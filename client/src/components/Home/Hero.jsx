    ...
    <section className="relative overflow-hidden border-b border-white/60">
      ...
      <Container className="relative grid items-center gap-10 py-12 lg:grid-cols-[1.15fr_0.85fr] lg:py-20">
        <div className="animate-fade-up">
          ...
          <h1 className="mt-4 max-w-xl text-ink">{t.hero.title}</h1>
          <p className="mt-4 max-w-xl text-base leading-7 text-ink-soft sm:text-lg">{t.hero.body}</p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
          <div className="surface p-6 sm:col-span-2 xl:col-span-2">
            ...
            <p className="mt-5 font-display text-2xl text-ink">{t.hero.cardTitle}</p>
            <p className="mt-3 max-w-sm text-sm leading-6 text-ink-soft">{t.hero.cardBody}</p>
          </div>
          <div className="surface flex items-start gap-3 p-5">
            ...
            <div>
              <p className="font-semibold text-ink">{t.hero.districts}</p>
              <p className="mt-1 text-sm text-ink-soft">{t.hero.districtsBody}</p>
            </div>
          </div>
          <div className="surface flex items-start gap-3 p-5">
            ...
            <div>
              <p className="font-semibold text-ink">{t.hero.direct}</p>
              <p className="mt-1 text-sm text-ink-soft">{t.hero.directBody}</p>
            </div>
          </div>
        </div>
      </Container>
